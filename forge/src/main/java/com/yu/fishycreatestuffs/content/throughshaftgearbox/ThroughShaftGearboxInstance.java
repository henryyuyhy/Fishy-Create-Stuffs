...
public class ThroughShaftGearboxInstance extends KineticBlockEntityInstance<ThroughShaftGearboxEntity> {

    protected final EnumMap<Direction, RotatingData> keys;
    protected Direction sourceFacing;

    public ThroughShaftGearboxInstance(MaterialManager materialManager, ThroughShaftGearboxEntity blockEntity) {
    ...
    private float getSpeed(Direction direction) {
        ...
        if (speed != 0 && sourceFacing != null) {
            speed *= ThroughShaftGearboxEntity.getRotationSpeedModifier(blockEntity.getBlockState(), direction, sourceFacing);
        }
        return speed;
    }
